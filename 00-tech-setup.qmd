...
- Go to [RStudio Pro](https://rstudio.deac.wfu.edu/) and open a project. Install the `usethis` package by running the following code in the Console
...
- Go to our class's GitHub organization [sta-779-s22](https://github.com/sta-779-s22)
